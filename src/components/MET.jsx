  ...
  return (
    <div className="components-section container-fluid">
      <div className="container">
        <h3 className="section-heading">Manufacturing Equipment / Tools
</h3>
        ...
        <div className="row main-box">
          ...
          <div className="col-lg-4 col-md-12 mb-4">
            <div className="left-banner">
              <img
  src={`https://react-live.sourceindia-electronics.com/v1/${data[5]?.file_name}`}
  alt={data[5]?.name || "category"}
...
/>
          ...
          <div className="col-lg-8 col-md-12">
            <div className="row">
              ...
              {data.length > 0 ? (
                data[5].subcategories.map((sub, index) => (
